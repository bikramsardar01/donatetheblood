...
if (isset($_POST['submit'])) {
	...
	if (isset($_POST['term']) === true) {
		...
		if (
			isset($name) && isset($blood_group) && isset($gender) && isset($day)
			...
			$sql = "INSERT INTO donor (
					name, gender, email, city, dob, contact_no, save_life_date, password, blood_group,type,status) VALUES('$name',
					'$gender', '$email','$city', '$DonorBOB', '$contact','0', '$password', '$blood_group', 'user','pending' )";
	...
	<div class="row">
		<div class="col-md-6 offset-md-3 form-container">
			...
			<form class="form-group" action="" method="post">
				...
				<div class="form-group">
					...
					<select name="city" id="city" class="form-control demo-default" required>
				...
				</option>'; ?><optgroup title="Koshi (Province1)" label="&raquo; Koshi (Province1)"></optgroup>
						...
						<optgroup title="Bagmati (Province3)" label="&raquo; Bagmati (Province3)"></optgroup>
