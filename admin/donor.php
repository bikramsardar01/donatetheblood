  ...
  <?php include 'nav.php'; ?>
          ...
          <form method="post">
                    ...
                    <select name="gender" class="form-select" required>
							...
							<option value="male" <?php if(isset($_GET['eid']) && $selected[0]['gender'] == 'male'){ echo 'selected'; } ?>>Male</option>
							<option value="female" <?php if(isset($_GET['eid']) && $selected[0]['gender'] == 'female'){ echo 'selected'; } ?>>Female</option>
                            <option value="other" <?php if(isset($_GET['eid']) && $selected[0]['gender'] == 'other'){ echo 'selected'; } ?>>Other</option>
			  			</select>
					</div>
                    <div class="mb-3">
					...
					<div class="mb-3">
                        <input type="text" class="form-control" name="city" placeholder="City" required
							value="<?php if(isset($_GET['eid'])) {echo $selected[0]['city'];}?>" >
					</div>
					<div class="mb-3">
						<input type="number" class="form-control" name="dob" placeholder="date of birth" required 
							value="<?php if(isset($_GET['eid'])) {echo $selected[0]['dob'];}?>">
					</div> 
                    <div class="mb-3">
						<input type="number" class="form-control" name="contact_no" placeholder="Contact_no" required 
							value="<?php if(isset($_GET['eid'])) {echo $selected[0]['contact_no'];}?>">
					</div> 
                    <div class="mb-3">
						<input type="date" class="form-control" name="save_life_date" placeholder="save life date" required 
							value="<?php if(isset($_GET['eid'])) {echo $selected[0]['save_life_date'];}?>">
					</div> 
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
						<input type="text" class="form-control" name="blood_group" placeholder="blood group" required 
							value="<?php if(isset($_GET['eid'])) {echo $selected[0]['blood_group'];}?>">
					</div> 
