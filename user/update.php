<?php 
	...
	if(isset($_SESSION['user_id']) && !empty($_SESSION['user_id'])){
		...
		if(isset($_POST['submit'])){
				...
				<strong>Select your blood_group input.</strong>
				<button type="button" class="close" data-dismiss="alert" aria-label="Close">
				  <span aria-hidden="true">&times;</span>
				</button>
			  </div>';
				...
				<button type="button" class="close" data-dismiss="alert" aria-label="Close">
				  <span aria-hidden="true">&times;</span>
					...
					&& isset($month) && isset($year) && isset($email) && isset($contact) && isset($city)){
						...
						$DonorBOB = $year."-".$month."-".$day;
		
						
						$sql = "UPDATE donor SET 
							name = '$name', gender='$gender',  email='$email', city='$city', dob='$DonorBOB', contact_no='$contact', blood_group='$blood_group'
				...
				if($oldpassword == $dbPassword){ 
					...
					if(strlen($_POST['new_password'])>=6){
						...
						if($_POST['new_password'] == $_POST['c_password']){
							...
							$passwordErro = ' <div class="alert alert-danger alert-dismissible fade show" role="alert">
  ...
  if(isset($_POST['userID'])){
	...
	if(mysqli_query($connection, $sql)){
        ...
        <strong>Account Not delete Try again.</strong>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
      </div>';
		...
		padding: 20px 10px 20px 30px;
			...
			<div class="row">
              ...
              <select class="form-control demo-default" id="blood_group" name="blood_group" required>
				...
				<?php if(isset($blood_group)) echo ' <option selected="" value="'.$blood_group.'">'.$blood_group.'
				</option>'; ?>
			  ...
			  <?php if(isset($blood_groupError)) echo $blood_groupError; ?>
					...
					<div class="form-group">
				              <label for="gender">Gender</label><br>
									...
									<?php if(isset($gender)) { if($gender=="Female") 
									echo "checked";} ?> >
              ...
              <select class="form-control demo-default" id="date" name="day" style="margin-bottom:10px;"
			   required>
				...
				<?php if(isset($date['2'])) echo ' <option selected="" value="'.$date['2'].'">'.$date['2'].'
				</option>'; ?>
              ...
              <select class="form-control demo-default" name="month" id="month" style="margin-bottom:10px;" required>
				...
				<?php if(isset($date['1'])) echo ' <option selected="" value="'.$date['1'].'">'.$date['1'].'
				</option>'; ?>
                <option value="01" >January</option><option value="02" >February</option><option value="03" >March</option><option value="04" >April</option><option value="05" >May</option><option value="06" >June</option><option value="07" >July</option><option value="08" >August</option><option value="09" >September</option><option value="10" >October</option><option value="11" >November</option><option value="12" >December</option>
              </select>
              <select class="form-control demo-default" id="year" name="year" style="margin-bottom:10px;" required>
                <option value="">---Year---</option>
				<?php if(isset($date['0'])) echo ' <option selected="" value="'.$date['0'].'">'.$date['0'].'
				</option>'; ?>
	           ...
	           <?php if(isset($cityError)) echo $cityError; ?>
				...
				<div class="card col-md-6 offset-md-3">
					...
					<!-- Messages -->	
						...
						<?php if(isset($passwordErro)) echo$passwordErro;
